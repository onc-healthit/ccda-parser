...
public class POTProcessor {
	...
	public static CCDAPOT retrievePOTDetails(XPath xPath , Document doc) throws XPathExpressionException,TransformerException
	{
		...
		if(sectionElement != null)
		{
			...
			pot.setPlannedMedicationActivity(MedicationProcessor.readMedication(plannedMedicationNodeList, xPath));
			...
			pot.setPlannedEncounter(EncounterDiagnosesProcessor.readEncounterActivity(plannedEncounterNodeList, xPath));
			...
			pot.setPlannedProcedure(ProcedureProcessor.readProcedures(plannedProcedureNodeList,xPath));
		}
